		...
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<div class="default_product_display product_view_<?php echo wpsc_the_product_id(); ?> <?php echo wpsc_category_class(); ?> group">
					...
					<div class="cover" id="covercol_<?php echo wpsc_the_product_id(); ?>">
						<?php if(wpsc_the_product_thumbnail()) : ?>
							<a rel="<?php echo wpsc_the_product_title(); ?>" class="<?php echo wpsc_the_product_image_link_classes(); ?>" href="<?php echo wpsc_the_product_image(); ?>">
								<img class="product_image" id="product_image_<?php echo wpsc_the_product_id(); ?>" alt="<?php echo wpsc_the_product_title(); ?>" title="<?php echo wpsc_the_product_title(); ?>" src="<?php echo wpsc_the_product_thumbnail('85','114'); ?>" width="85" />
							</a>
						<?php else: ?>
				...
				<div class="insidecol categoria">
					...
					<?php endif; ?>
					<p><a class="btn" href="<?php echo wpsc_the_product_permalink(); ?>">Veja Mais</a></p>
					<p class="clr"></p>
				</div><!--close insidecol-->
