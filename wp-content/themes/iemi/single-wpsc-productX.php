...
<div id='products_page_container' class="wrap wpsc_container">
	...
	<?php /** start the product loop here, this is single products view, so there should be only one */?>
		<?php while (wpsc_have_products()) :  wpsc_the_product(); ?>
			...
			<h1 class="entry-title prodtitles"><a href="<?php echo wpsc_the_product_permalink(); ?>"><?php echo wpsc_the_product_title(); ?></a></h1>
			...
			<div class="single_product_display product_view_<?php echo wpsc_the_product_id(); ?>">
				<div class="textcol">
					...
					<div class="wpsc_quantity_and_variations">
						<!-- THIS IS THE QUANTITY OPTION MUST BE ENABLED FROM ADMIN SETTINGS -->
						<?php if(wpsc_has_multi_adding()): ?>
							<div class="wpsc_quantity">
						...
						<?php /** the variation group HTML and loop ends here */?>
							...
							<?php else : ?>
								...
								<?php endif; ?>
								Preço: <span id="product_price_<?php echo wpsc_the_product_id(); ?>" class="pricedisplay"><?php echo wpsc_the_product_price(); ?></span> <br/>
								<!-- multi currency code -->
